...
<div class="space-y-6">
    ...
    <section class="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-slate-200">
        <form method="GET" action="{{ route('students.excel') }}" class="space-y-5">
            ...
            <div class="flex flex-wrap items-center justify-end gap-3">
                <a href="{{ route('students.excel') }}" class="inline-flex items-center rounded-2xl bg-slate-100 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-200">
                    إعادة التعيين
                </a>
