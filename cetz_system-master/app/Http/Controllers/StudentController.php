        ...
        if ($request->status === 'تم التجديد') {
            ...
            if ($carryCoursesCount > 3) {
                return response()->json([
                    'success' => false,
                    'message' => "لا يمكن تمرير الطالب إلى السيمستر التالي لأن لديه {$carryCoursesCount} مواد مرحلة. يجب أن ينجح في مادة واحدة على الأقل.",
                    'carry_courses_count' => $carryCoursesCount,
                ], 422);
            }
            ...
            if ($repeatedFailedCoursesCount > 0) {
                return response()->json([
                    'success' => false,
                    'message' => 'لا يمكن تمرير الطالب إلى السيمستر التالي لأن لديه مادة أو أكثر أعادها 3 مرات ولم ينجح فيها بعد.',
                    'repeated_failed_courses_count' => $repeatedFailedCoursesCount,
                ], 422);
            }
        }
